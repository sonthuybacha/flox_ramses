...
store <- hold[which(hold[,2] >= "11:30:00" & hold[,2] <= "12:30:00"),]
...
s2 <- hold[which(hold[,3] <= 705 & hold[,3] >= 695 & hold[,1] == "SAM_8623"),]
s3 <- hold[which(hold[,3] <= 710 & hold[,3] >= 700 & hold[,1] == "SAM_8624"),]
